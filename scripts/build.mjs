...
function imageGallery() {
  return `<div class="image-gallery" data-image-gallery role="dialog" aria-modal="true" aria-label="Image gallery" hidden><button class="gallery-close" type="button" data-gallery-close aria-label="Close image gallery">×</button><button class="gallery-nav gallery-prev" type="button" data-gallery-prev aria-label="Previous image">←</button><figure class="gallery-figure"><img data-gallery-image alt=""><figcaption class="gallery-meta"><span data-gallery-caption></span><span data-gallery-count aria-live="polite"></span></figcaption></figure><button class="gallery-nav gallery-next" type="button" data-gallery-next aria-label="Next image">→</button></div>`;
}
