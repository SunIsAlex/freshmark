...
export function commentsEmailVerificationEnabled(environment = process.env) {
  return /^(?:1|true|yes|on)$/i.test(environment.FRESHMARK_COMMENTS_EMAIL_VERIFICATION?.trim() || "");
}
